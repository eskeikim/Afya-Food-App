...
var _foodItemTempValue= MutableLiveData<List<FoodItem>?>()
    ...
    init {
    dummyList.add(
        BrandedList("Gither","Githe",3,"Kenya Githeri","Kenya",44,
            "23","32", BrandedPhoto("",
                false,"https://nix-tag-images.s3.amazonaws.com/3917_thumb.jpg"),33,23,""),
    )
        dummyList.add(
        BrandedList("Rice","Rice",3,"Kenya Rice","Kenya",76,
            "23","32", BrandedPhoto("",
                false,"https://nix-tag-images.s3.amazonaws.com/3917_thumb.jpg"),33,4,""),
    )
        getInstantItemsTest("")
        getFoodItemRoomDB()
    }
